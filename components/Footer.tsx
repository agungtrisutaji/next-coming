...
function MagneticSocialLink({ 
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="group relative w-14 h-14 flex items-center justify-center bg-zinc-900/80 border border-zinc-700/50 rounded-xl text-zinc-400 transition-all duration-300 hover:text-white hover:border-[#ff0033]/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff0033] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
      aria-label={name}
    >
      {/* Glow effect on hover */}
      <motion.div
        className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#ff0033] to-[#ff006e] opacity-0 group-hover:opacity-15 transition-opacity duration-300"
      />
      <motion.div
        className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        style={{
          boxShadow: '0 0 25px rgba(255, 0, 51, 0.3), inset 0 0 15px rgba(255, 0, 51, 0.05)',
        }}
      />
      
      {/* Border animation */}
      <motion.div
        className="absolute inset-0 rounded-xl border-2 border-transparent group-hover:border-[#ff0033]/40 transition-colors duration-300"
      />
...
export default function Footer() {
  return (
    <footer className="relative py-20 md:py-28 overflow-hidden border-t border-zinc-800/60">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="text-center space-y-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-zinc-300 font-[family-name:var(--font-inter)] leading-relaxed">
